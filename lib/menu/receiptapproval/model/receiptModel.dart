...
class receiptModel {
  ...
  factory receiptModel.fromJson(Map<String, dynamic> json) {
    ...
    return receiptModel(
        ...
        kemasanadalogohalal: jsonkemasan['rcptk_has_logo_halal'],
        kemasantidakadalogohalal: jsonkemasan['rcptk_no_logo_halal'],
        kemasantidakditerapkanlogohalal: jsonkemasan['rcptk_not_regulated_logo_halal'],
