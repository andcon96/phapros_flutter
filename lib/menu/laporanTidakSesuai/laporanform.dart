...
class _laporanform extends State<laporanform> {
  ...
  Future takeImage() async {
    imagefromphoto = await ImagePicker()
          ...
          content: Column(
            children: <Widget>[
              ...
              TextFormField(
                controller: UM,
                readOnly: true,
                decoration: const InputDecoration(labelText: 'UM PO'),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return '-';
                  }
              ...
              TextFormField(
                controller: UMPR,
                readOnly: true,
                decoration: const InputDecoration(labelText: 'UM PR'),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return '-';
                  }
              ...
              TextFormField(
                controller: UMKonv,
                readOnly: true,
                decoration: const InputDecoration(labelText: 'UM Konversi'),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return '-';
                  }
